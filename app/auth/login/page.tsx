...
function LoginForm() {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-navy-100 p-8">
      <h2 className="text-2xl font-bold text-navy-900 mb-6">Acceder</h2>
        ...
        <>
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-navy-900 hover:bg-navy-800 text-white font-semibold py-2.5 rounded-lg transition-colors disabled:opacity-50"
            >
